...
public final class PaintUtil {
    ...
    private static final float DEFAULT_SNAPONGRID_THICKNESS_PX = 3;
    //endregion
    ...
    /**
     * Creates the Paint object for drawing the snap on grid crossline.
     *
     * @return the new Paint object
     */
    public static Paint newSnapOnGridPaint(int snapGridThichness) {

        final Paint paint = new Paint();
        //paint.setColor(Color.parseColor(SEMI_TRANSPARENT));
        paint.setStrokeWidth(snapGridThichness); //DEFAULT_SNAPONGRID_THICKNESS_PX
    ...
    public static Paint newCornerCirclePaint(Context context) {
        ...
        final Paint cornerPaint = new Paint();
        cornerPaint.setColor(context.getResources().getColor(R.color.CropperGreen));
        cornerPaint.setStrokeWidth(lineThicknessPx);
    ...
    public static Paint newPixelCounterPaint(Context context) {
        ...
        final Paint cornerPaint = new Paint();
        cornerPaint.setColor(context.getResources().getColor(R.color.Black));
        cornerPaint.setStrokeWidth(lineThicknessPx);
        cornerPaint.setStyle(Paint.Style.FILL_AND_STROKE);
    ...
    public static Paint newPixelCounterTextPaint(Context context) {

        final Paint cornerPaint = new Paint();
        cornerPaint.setColor(context.getResources().getColor(R.color.White));
        cornerPaint.setTextSize(20);
        cornerPaint.setStyle(Paint.Style.FILL);
        cornerPaint.setShadowLayer(1.0f, 3.0f, 3.0f, Color.BLACK);
