...
public class TipSecond extends Fragment{
    ...
    public static TipSecond newInstance(String text, int fragNum, int layResId, int drawableId) {

    	TipSecond.layResId = layResId;
    	TipSecond.fragNum = fragNum;
    	TipSecond f = new TipSecond();
